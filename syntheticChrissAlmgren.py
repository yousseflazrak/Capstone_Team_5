...
class MarketEnvironment():
    ...
    def __init__(self, randomSeed = 0,
        ...
        self.logReturns = collections.deque(np.zeros(6))  #list-like container with fast appends and pops on either end
    ...
    def step(self, action1,action2):
        ...
        # number of trades or if the total number shares remaining is less (superior?) than 1, then stop transacting,
